 ...
 * @author Davis
 */
public class JugarLoteriaNacional extends javax.swing.JFrame {

    /**
     * Creates new form JugarLoteriaNacional
     */
     public Jugador persona;
    public JugarLoteriaNacional() {
        initComponents();
    }

    public JugarLoteriaNacional(Jugador jugador){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Jugar Lotería Nacional");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int[] resultado = persona.jugarLoteriaNacional();
        LoteriaNacional tiquete = new LoteriaNacional("19/11/2021", resultado);

        comprasSorteos.sorteos.add(tiquete);
        comprasSorteos.usuarios.add(persona);

        numeros.setText("Tu numero es -  Serie:"+resultado[0]+", Número: "+resultado[1]);
        jButton3.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JugarLoteriaNacional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JugarLoteriaNacional().setVisible(true);
            }
        });
    }
